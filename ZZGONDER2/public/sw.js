...
const saveSubscription = async (subscription) => {
    const response = await fetch('https://umutsar.net/save-subscription', {
        method: 'post',
...
self.addEventListener('notificationclick', function(event) {
    ...
    event.waitUntil(
        clients.openWindow('https://umutsar.net/chat.html') // Yeni pencereyi açmak için istediğiniz URL'yi buraya ekleyin
    );
});